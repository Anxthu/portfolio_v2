        ...
        <article className="section-padding pt-32 pb-24">
          ...
          >
            ...
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-6xl font-heading font-bold tracking-tight text-[#E52E2D] mb-6">
                {post.title}
              </h1>
            ...
            <div className="prose prose-lg max-w-none mb-12">
              {post.content.map((section, i) => (
                <div key={i} className="mb-8">
                  ...
                  {section.type === "list" && (
                    <ul className="list-disc list-inside space-y-2 text-black/80 mb-6">
